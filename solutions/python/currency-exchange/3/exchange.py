...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    actual_spread = exchange_rate + spread / 100 * exchange_rate
    total_currency = exchange_money(budget, actual_spread)
    return get_number_of_bills(total_currency, denomination) * denomination